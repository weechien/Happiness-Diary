...
public class Prayer extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prayer); // Setup the child layout for the container
    }

    @Override
    protected void onResume() {
        super.onResume();
        setPrayerLocale(LocaleHelper.getLanguage(this));

        // Set the text view in the navigation drawer as checked
        CheckedTextView checkedTextView = findViewById(R.id.prayer);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_english && !LocaleHelper.getLanguage(this).equals("en")) {
            ...
            setPrayerLocale("en"); // Reset this activity's views
    ...
    void setPrayerLocale(String language) {
        Context context = LocaleHelper.setLocale(this, language);
        Resources resources = context.getResources();

        TextView textView = findViewById(R.id.toolbar_base_textview);
        textView.setText(resources.getString(R.string.title_activity_prayer)); // Title of the activity
